...
module.exports = {
  ...
  apiGetActivityCardInfo: () =>
    request2({ url: `${BASE}api/activity/verify/318/getActivityCardInfo`, data: {}, method: 'POST', auth: true, encrypt: false, isJson: true }),

  /** 获取奖品列表（分页），参数走 query：page、limit、orderBy、orderType、needStarCount（可选） */
  apiGetPrizeList: (data) =>
    request2({
      url: `${BASE}api/activity/verify/318/prize/list${buildPrizeListQuery(data)}`,
      data: {},
      method: 'POST',
      auth: true,
      encrypt: false,
